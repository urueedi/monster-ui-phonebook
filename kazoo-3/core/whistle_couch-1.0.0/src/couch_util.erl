...
db_classification(<<"numbers%2f", _Prefix:5/binary>>) -> 'numbers';
db_classification(<<"ratedeck-", _AccountId:32/binary>>) -> 'ratedeck';
db_classification(<<"lcrrates-", _AccountId:32/binary>>) -> 'lcrrates';
db_classification(<<"phonebook-", _AccountId:32/binary>>) -> 'phonebook';
...
db_classification(?WH_PHONEBOOK_DB) -> 'system';
db_classification(?WH_LCRRATES_DB) -> 'system';
